        ...
        <div id="sidebarMenu" class="flex-1 flex flex-col" role="menu">
          ...
          <div class="flex flex-col mt-1">
            ...
            <div id="studentsMenu" class="hidden flex-col mt-1" role="menu" aria-hidden="true">
              ...
              <a href="<?php echo SITEURL ?>view_student.php" class="block px-2 py-2 pl-8 text-white w-full text-sm hover:bg-[#0f1b33] " role="menuitem">
                <i class="fa-solid fa-eye" aria-hidden="true"></i>
                View Students
              </a>
              <a href="<?php echo SITEURL ?>update_student_data.php" class="block px-2 py-2 pl-8 text-white w-full text-sm hover:bg-[#0f1b33] " role="menuitem">
